...
function App() {
  return (
    <div className="container h-[800px] w-full mx-auto my-20">
      ...
      {/* Search and nav bar */}
      <div  className="flex flex-row justify-between my-10 mx-auto ">
        {/* Search Box */}
        <input className="w-[300px] text-left border p-4  rounded-sm display block justify-center " type="text" placeholder="Search Users" />
        {/* Buttons or nav bar */}
        <div className=" ">
      ...
      <div className="grid grid-cols-3 my-24 gap-24  justify-between">
